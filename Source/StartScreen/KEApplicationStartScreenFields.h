...
OSG_BEGIN_NAMESPACE
template <>
struct FieldDataTraits<ke::ApplicationStartScreenPtr> : 
    public FieldTraitsRecurseMapper<ke::ApplicationStartScreenPtr, true>
{
    ...
    static char     *getSName(void) { return "SFApplicationStartScreenPtr"; }
    static char     *getMName(void) { return "MFApplicationStartScreenPtr"; }
};
OSG_END_NAMESPACE
