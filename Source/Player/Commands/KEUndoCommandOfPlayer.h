...
typedef boost::shared_ptr<UndoCommandOfPlayer> UndoCommandOfPlayerRefPtr;

class KE_KABALAENGINE_DLLMAPPING UndoCommandOfPlayer: public Command
{
protected:
	typedef Command Inherited;
	typedef UndoCommandOfPlayerRefPtr RefPtr;

	UndoCommandOfPlayer(ApplicationPlayerRefPtr ApplicationPlayer);
...
public:
	...
	static UndoCommandOfPlayerRefPtr create(ApplicationPlayerRefPtr ApplicationPlayer);
};
