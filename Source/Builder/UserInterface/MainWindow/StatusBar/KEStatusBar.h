...
#include <OpenSG/OSGProgressBarFields.h>
...
class KE_KABALAENGINE_DLLMAPPING StatusBar : public StatusBarBase
{
  protected:
  ...
  public:
    ...
    void setProgressEnable(bool Enable);
    void setStatusText(const std::string& Text);
    void setStatusIcon(UInt16 IconEnum);
    void setProgress(Int32 Progress);
    void clearStatus(void);

    bool getProgressEnable(void) const;
    const std::string& getStatusText(void) const;
    UInt16 getStatusIcon(void) const;
  ...
  protected:
    ...
    ButtonRecPtr      _IconButton;
    LabelRecPtr       _StatusLabel;
