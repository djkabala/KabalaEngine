...
UndoCommandPtr UndoCommand::create(ApplicationBuilderPtr TheApplicationBuilder)
{
	return Ptr(new UndoCommand(TheApplicationBuilder));
}
...
void UndoCommand::execute(void)
{
	...
	_TheApplicationBuilder->getUndoManager()->undo();
}
