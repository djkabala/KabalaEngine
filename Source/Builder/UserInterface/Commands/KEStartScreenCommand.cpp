...
/*! \class osg::StartScreenCommand
A StartScreenCommand. 
*/
...
CommandType StartScreenCommand::_Type("StartScreenCommand", "Command");
/***************************************************************************\
 *                           Class methods                                 *
\***************************************************************************/
...
{
	return std::string("Go To Start Screen");
}

const CommandType &StartScreenCommand::getType(void) const
{
	return _Type;
}
/*-------------------------------------------------------------------------*\
...
StartScreenCommand::~StartScreenCommand(void)
{
}
