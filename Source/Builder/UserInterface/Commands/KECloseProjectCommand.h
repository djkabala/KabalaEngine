...
typedef boost::shared_ptr<CloseProjectCommand> CloseProjectCommandPtr;

class KE_KABALAENGINE_DLLMAPPING CloseProjectCommand: public Command
{
protected:
...
public:
	...
	static CloseProjectCommandPtr create(void);
};
