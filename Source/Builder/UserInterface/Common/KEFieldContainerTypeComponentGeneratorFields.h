...
template <>
struct FieldDataTraits<FieldContainerTypeComponentGeneratorPtr> : 
    public FieldTraitsRecurseMapper<FieldContainerTypeComponentGeneratorPtr, true>
{
    ...
    static const char *getSName(void) { return "SFFieldContainerTypeComponentGeneratorPtr"; }
    static const char *getMName(void) { return "MFFieldContainerTypeComponentGeneratorPtr"; }
};
