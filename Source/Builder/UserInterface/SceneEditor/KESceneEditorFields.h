...
OSG_BEGIN_NAMESPACE
template <>
struct FieldDataTraits<ke::SceneEditorPtr> : 
    public FieldTraitsRecurseMapper<ke::SceneEditorPtr, true>
{
    ...
    static char     *getSName(void) { return "SFSceneEditorPtr"; }
    static char     *getMName(void) { return "MFSceneEditorPtr"; }
};
OSG_END_NAMESPACE
