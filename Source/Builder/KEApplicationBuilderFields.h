...
OSG_BEGIN_NAMESPACE
template <>
struct FieldDataTraits<ke::ApplicationBuilderPtr> : 
    public FieldTraitsRecurseMapper<ke::ApplicationBuilderPtr, true>
{
    ...
    static char     *getSName(void) { return "SFApplicationBuilderPtr"; }
    static char     *getMName(void) { return "MFApplicationBuilderPtr"; }
};
OSG_END_NAMESPACE
