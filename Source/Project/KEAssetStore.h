...
#ifndef _KEASSETSTORE_H_
#define _KEASSETSTORE_H_
#ifdef __sgi
#pragma once
#endif
...
/*! \brief AssetStore class. See \ref
           PageKabalaEngineAssetStore for a description.
*/

class KE_KABALAENGINE_DLLMAPPING AssetStore : public AssetStoreBase
{
  protected:
  ...
  public:
    ...
    typedef AssetStoreBase Inherited;
    typedef AssetStore     Self;
  ...
  protected:
    ...
    // Variables should all be in AssetStoreBase.
    ...
    AssetStore(void);
    AssetStore(const AssetStore &source);
  ...
  private:
    ...
    friend class AssetStoreBase;

    // prohibit default functions (move to 'public' if you need one)
    void operator =(const AssetStore &source);
};

typedef AssetStore *AssetStoreP;
...
#include "KEAssetStoreBase.inl"
#include "KEAssetStore.inl"

#endif /* _KEASSETSTORE_H_ */
