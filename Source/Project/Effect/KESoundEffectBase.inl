...
inline
OSG::FieldContainerType &SoundEffectBase::getClassType(void)
{
    return _type;
}
...
inline
OSG::UInt32 SoundEffectBase::getClassTypeId(void)
{
    return _type.getId();
}

inline
OSG::UInt16 SoundEffectBase::getClassGroupId(void)
{
...
inline
void SoundEffectBase::execSync (      SoundEffectBase *pFrom,
...
inline
const Char8 *SoundEffectBase::getClassname(void)
{
    return "SoundEffect";
}
